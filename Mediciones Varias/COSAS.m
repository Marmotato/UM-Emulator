...
resultado = sv(1, 2, 3, 4, 5, 6, fv)

Pij=P_expt(gv,fv,W,H,X,Y,t,es,d_v,s_v)
...
g=gain(eta,incidencia_radian1,incidencia1,fov);
digits(2);
dm= d1/c;
dm=vpa(dm);
dm=double(subs(dm));

if (incidencia_radian1>=0) && (incidencia_radian1<=2*fov)
