...
class prbs_test(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Prbs Test", catch_exceptions=True)
        ...
        self._sro_range = qtgui.Range(-1e-1, 1e-1, 1e-3, 0, 200)
        self._sro_win = qtgui.RangeWidget(self._sro_range, self.set_sro, "Sample Rate Offset", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._sro_win)
        self._cfo_range = qtgui.Range(-1e-1, 1e-1, 1e-3, 0, 200)
        self._cfo_win = qtgui.RangeWidget(self._cfo_range, self.set_cfo, "Freq Offset", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.uhd_usrp_source_1_0.set_center_freq(0, 0)
        self.uhd_usrp_source_1_0.set_antenna('RX2', 0)
        self.uhd_usrp_source_1_0.set_gain(0, 0)
        ...
        self.uhd_usrp_sink_1_0.set_time_now(uhd.time_spec(time.time()), uhd.ALL_MBOARDS)

        self.uhd_usrp_sink_1_0.set_center_freq(0, 0)
        self.uhd_usrp_sink_1_0.set_antenna("TX/RX", 0)
        self.uhd_usrp_sink_1_0.set_gain(0, 0)
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, 'C:\\Users\\ariel\\OneDrive\\Desktop\\beemovie.txt', True, 0, 0)
        ...
        self.connect((self.channels_channel_model_0, 0), (self.uhd_usrp_sink_1_0, 0))
        ...
        self.connect((self.uhd_usrp_source_1_0, 0), (self.root_raised_cosine_filter_0_0, 0))
