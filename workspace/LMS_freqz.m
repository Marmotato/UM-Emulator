...
desired = awgn(sys_out, SNR);    % Addition of white gaussian noise (desired signal after disturbance)
...
%% Results
% Impulse response
[bb]=invfreqz(conj(temp1'),Freq_vector,3,0);     % Estimated channel impulse response
